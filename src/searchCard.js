            ...
            return (
                <div className="p-2">
                    <Card className="shadow" onClick={() => this.handleCardClick(this.props.eachArticle)}>
                        <Card.Body>
                            <div>
                                <Card.Title className="font-italic"><Truncate lines={2}>{this.props.eachArticle.title}</Truncate><span> </span><MdShare size={18} onClick={this.handleShareClick}/></Card.Title>
                            </div>
