...
class MainCardNY extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            share: false,
    ...
    render() {
        ...
        return (
            <div>
                <Card className="m-3 mb-4 shadow" onClick={() => this.handleCardClick(this.props.eachArticle.id)}>
